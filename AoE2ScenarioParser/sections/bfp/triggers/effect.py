...
class Effect(BaseStruct):
    ...
    def set_sel_obj_ids_repeat(_, instance: Effect):
        ...
        Retriever.set_repeat(Effect._selected_object_ids, instance, repeat)
    ...
    def update_num_obj_sel(_, instance: Effect):
        instance._num_objects_selected = len(instance.selected_object_ids)

    # formatter:off
    # todo: use datasets for type hinting and do on_read and on_write conversions
    # todo: override list with reflist in retriever
    type: int                              = Retriever(int32,                               default=-1)
    _static_value_2_2_1_36: int            = Retriever(int32, max_ver=(2, 2, 1, 37), default=46)
    _static_value_2_4_1_40: int            = Retriever(int32, (2, 4, 1, 40), (2, 4, 1, 41), default=48)
    _static_value_2_4_1_42: int            = Retriever(int32, (2, 4, 1, 42), (2, 4, 1, 43), default=49)
    _static_value_2_4_1_44: int            = Retriever(int32, (2, 4, 1, 44), default=52)
    ...
    _player_colour: int                    = Retriever(int32, (2, 4, 1, 40),                default=-1)
    _unknown4: int                         = Retriever(int32, (2, 4, 1, 40),                default=-1)
    _colour_mood: int                      = Retriever(int32, (2, 4, 1, 42),                default=-1)
    _reset_timer: int                      = Retriever(int32, (2, 4, 1, 44),                default=-1)
    _object_state: int                     = Retriever(int32, (2, 4, 1, 44),                default=-1)
    _action_type: int                      = Retriever(int32, (2, 4, 1, 44),                default=-1)
